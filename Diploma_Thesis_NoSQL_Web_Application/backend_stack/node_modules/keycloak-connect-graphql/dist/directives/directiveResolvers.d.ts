 ...
 *
 */
export declare const auth: (next: Function) => (...params: any[]) => any;
/**
 *
 ...
 * ```
 */
export declare const hasRole: (roles: Array<string>) => (next: Function) => (...params: any[]) => any;
/**
 *
 ...
 * ```
 */
export declare const hasPermission: (permissions: Array<string>) => (next: Function) => (...params: any[]) => Promise<any>;
