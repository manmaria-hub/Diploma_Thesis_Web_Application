...
exports.KeycloakSubscriptionContext = exports.KeycloakContext = exports.KeycloakContextBase = exports.CONTEXT_KEY = void 0;
const KeycloakPermissionsHandler_1 = require("./KeycloakPermissionsHandler");
exports.CONTEXT_KEY = 'kauth';
class KeycloakContextBase {
    constructor(token, keycloak = undefined, authorizationConfiguration = undefined) {
        this.accessToken = token;
        if (keycloak) {
            this.permissionsHandler = new KeycloakPermissionsHandler_1.KeycloakPermissionsHandler(keycloak, token, authorizationConfiguration);
        }
    }
    /**
   ...
   */
    async hasPermission(expectedPermissions) {
...
class KeycloakContext extends KeycloakContextBase {
    constructor({ req }, keycloak = undefined, authorizationConfiguration = undefined) {
