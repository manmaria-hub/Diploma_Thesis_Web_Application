...
import UndergraduateCoursesListContainer from "./UnderGraduateCoursesListContainer";

// CSS Styles
import '../../../../../src/styles/pages/FOR_ALL_PAGES/COURSES_INFO/COURSES_LIST/coursesList.scss';
...
const CoursesList = () => { 
    ...
    return(
        <>
        {token !== 'null' ?
        <div className="courses_list_page">  
            <div className="courses_list_scroll_page">
                <div className="courses_list_container"> 
                    <div className={leftSide}> 
                        <AdminSidebar onShow={()=>setRightSideBar(true)} onNotShow={()=>setRightSideBar(false)} document='under_courses'/>         
                        
                    </div> 
                    <div className={rightSide}>
                        <AdminNavbar/>
                        <CoursesNavbar action ='courses_list' connectedUser={localStorage.getItem('userIdentity')}/>       
                        <UndergraduateCoursesListContainer connectedUser={localStorage.getItem('userIdentity')} />               
                    </div> 
                </div> 
            </div>
        </div> : <Login></Login>}
