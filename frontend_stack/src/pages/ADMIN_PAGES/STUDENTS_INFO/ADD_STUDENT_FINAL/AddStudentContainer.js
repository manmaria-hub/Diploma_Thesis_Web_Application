...
// CSS Styles
import '../../../../../src/styles/pages/ADMIN_PAGES/STUDENTS/ADD_STUDENT_FINAL/addStudentContainer.scss';
...
function MyVerticallyCenteredModal(props) { 
	...
	const closeModal = (closeTag) => {		 
		props.onChange(closeTag);	 
		props.onHide(); 
	}

	// Handling CHECK Button
	const continueChecking = (checkTag) => {  
		props.onChange(checkTag);	 
		props.onHide();
	}

	// Handling ADD Button 
	const addNewStudent = (addTag) => { 
		props.onChange(addTag);	 
		props.onHide();			
	}
	...
	return (
	  ...
	  >
		...
		<Modal.Body className='studentBody'>
		<div className="complete_message">
            Ο φοιτητής με <p>ΣΤΟΙΧΕΙΑ ΠΡΟΦΙΛ</p> που φαίνονται στην καρτέλα που ακολουθεί πρόκειται να καταχωρηθεί στην Ηλεκτρονική Γραμματεία του Τμήματος Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Πανεπιστημίου Θεσσαλίας :
            </div>
		<div className="profileCard" style={{marginBottom:'5rem'}}>
                <div className="wrapper">
                    <div className="left">
                        <div className="first_part">
                            {props.new_student.personal_info.Personal_Information.gender === 'Θήλυ' ?  <img  src={newFemaleStudent} alt='student' style={{backgroundColor:'rgba(255, 255, 255, 0.5)', border:'0.5px solid rgba(136, 136, 136, 0.4)', padding:'0.65rem 0.65rem', borderRadius:'50%', boxShadow:'1px 1px 20px 1px gray' }} width='100'/> :  <img  src={newMaleStudent} alt='student' style={{backgroundColor:'rgba(255, 255, 255, 0.5)', border:'0.5px solid rgba(136, 136, 136, 0.4)', padding:'0.65rem 0.65rem', borderRadius:'50%', boxShadow:'1px 1px 20px 1px gray' }} width='100'/> }                           
                            <h4>{(props.new_student.personal_info.Personal_Information.first_name !== '' && props.new_student.personal_info.Personal_Information.first_name !== undefined) ? props.new_student.personal_info.Personal_Information.last_name + ' ' + props.new_student.personal_info.Personal_Information.first_name : 'Μανταφούνη Μαρία'}</h4>
                            {props.new_student.studenship_info.General_Information.course_program_part !== '' && props.new_student.studenship_info.General_Information.course_program_part !== undefined ?
							<p>{(props.new_student.studenship_info.General_Information.course_program_part.endsWith('(ΠΡΟΠΤΥΧΙΑΚΕΣ ΣΠΟΥΔΕΣ)') === true && props.new_student.personal_info.Personal_Information.gender === 'Άρρεν') ? 'Προπτυχιακός Φοιτητής' : (props.new_student.studenship_info.General_Information.course_program_part.endsWith('(ΠΡΟΠΤΥΧΙΑΚΕΣ ΣΠΟΥΔΕΣ)') === true && props.new_student.personal_info.Personal_Information.gender === 'Θήλυ') ? 'Προπτυχιακή Φοιτήτρια' : (props.new_student.studenship_info.General_Information.course_program_part === 'ΜΕΤΑΠΤΥΧΙΑΚΕΣ ΣΠΟΥΔΕΣ' && props.new_student.personal_info.Personal_Information.gender === 'Θήλυ') ? 'Μεταπτυχιακή Φοιτήτρια' : 'Μεταπτυχιακός Φοιτητής'}</p> :
							<p>Προπτυχιακός Φοιτητής</p>}
                        </div>                                
                    </div>
                    <div className="right">
                        <div className="info">
                            <img  className='logo' src ={ECEUTH} alt="logo" width='60%'></img>
                            <h3>Προφίλ Φοιτητή</h3>     
                            <div className="info_data">
                                <div className="data">
                                    <h4>Ακαδημαϊκή Ταυτότητα</h4>
                                    <p>{props.new_student.studenship_info.General_Information.academic_identity !== '' && props.new_student.studenship_info.General_Information.academic_identity  !== undefined ? props.new_student.studenship_info.General_Information.academic_identity : 'stu35678'}</p>
                                </div>
                                <div className="data">
                                    <h4>Αριθμός Μητρώου</h4>
                                    <p>{props.new_student.studenship_info.General_Information.academic_record_number !== '' && props.new_student.studenship_info.General_Information.academic_record_number  !== undefined ? props.new_student.studenship_info.General_Information.academic_record_number : '02706'}</p>
                                </div>
                                <div className="data">
                                    <h4>Όνομα Χρήστη</h4>
                                    <p>{props.new_student.personal_info.Personal_Information.username !== '' && props.new_student.personal_info.Personal_Information.username  !== undefined ? props.new_student.personal_info.Personal_Information.username : 'manmaria'}</p>
                                </div>
                                <div className="data">
                                    <h4>Τμήμα</h4>
                                    <p>{props.new_student.studenship_info.General_Information.department + ' (' + props.new_student.studenship_info.General_Information.department_number + ') '}</p>
                                </div>
                                <div className="data">
                                    <h4>Πρόγραμμα Σπουδών</h4>
                                    <p>{props.new_student.studenship_info.General_Information.course + ' (' + props.new_student.studenship_info.General_Information.course_number + ') '}</p>
                                </div>
                                <div className="data">
                                    <h4>Κατάσταση Φοιτητή</h4>
                                    {props.new_student.personal_info.Personal_Information.active === true ? <p style={{color:'rgb(20, 191, 22)', marginTop:'-0.25rem', fontWeight:'700', fontSize:'17px', letterSpacing:'1.5px'}}>Ενεργός</p> : <p style={{color:'red',  marginTop:'-0.25rem', fontWeight:'700', fontSize:'17px', letterSpacing:'1.5px'}}>Μη Ενεργός</p>}
                                </div>
                            </div>
                        </div>
                    </div>
		...
		<Modal.Footer>
	      <Button onClick={() => continueChecking('check')}>Επανέλεγχος</Button>
		  <Button onClick={() => closeModal('close')}>Άκυρο</Button>
		  <Button onClick={() => addNewStudent('add')}>Εισαγωγή</Button>
		</Modal.Footer>
	  </Modal>
	);
  }
...
const AddStudentContainer = () => {
	...
	// State Variable that determines the state of unsuccess adding action
	let [isNotAdding, setIsNotAdding] = useState(false);
	...
	// State Variable that determines the state of Modal Window
	...
	const handleNext = () => {
		...
		if (isOK === true) { 
			console.log(activeStepFirstForm, 'step')
	...
	const handleNextSecond = () => {
		...
		if (activeStepSecondForm === 0 ) {
			...
			if (studentInfo_StudentshipInfo?.General_Information?.course_program_part === '' || studentInfo_StudentshipInfo?.General_Information?.course_program_part === undefined) {
		...
		if (activeStepSecondForm === 1 ) {
			...
			if (studentInfo_StudentshipInfo?.Registration_Details?.registration_period === '' || studentInfo_StudentshipInfo?.Registration_Details?.registration_period === undefined) {
		...
		if (activeStepSecondForm === 2 ) {
			...
			if (studentInfo_StudentshipInfo?.Professor_Advisor_Details?.professorAdvisor_LastName === '' || studentInfo_StudentshipInfo?.Professor_Advisor_Details?.professorAdvisor_LastName === undefined) {
			...
			if (studentInfo_StudentshipInfo?.Professor_Advisor_Details?.professorAdvisor_Email === '' || studentInfo_StudentshipInfo?.Professor_Advisor_Details?.professorAdvisor_Email === undefined) {
	...
	const handleChangeGender = (event) => {
		...
		document.getElementById('gender').getElementsByClassName('errorValue')[0].style.display = 'none';
	...
	useEffect(()=> {
		if (studentInfo_PersonalInfo?.Personal_Information?.gender !== '') {
			if (studentInfo_PersonalInfo?.Personal_Information?.gender === 'Άρρεν') {
				setStudentInfo_PersonalInfo(studentInfo_PersonalInfo => ({...studentInfo_PersonalInfo, Personal_Information:{...studentInfo_PersonalInfo.Personal_Information, sex:'Κος'}, Birth_Details:{...studentInfo_PersonalInfo.B3, gender:'Άρρεν'}}))
			}
			else if (studentInfo_PersonalInfo?.Personal_Information?.gender === 'Θήλυ') {
				setStudentInfo_PersonalInfo(studentInfo_PersonalInfo => ({...studentInfo_PersonalInfo, Personal_Information:{...studentInfo_PersonalInfo.Personal_Information, sex:'Κα'}, Birth_Details:{...studentInfo_PersonalInfo.B3, gender:'Θήλυ'}}))
			} 
		}
	...
	useEffect(() => {
		if (activeStepFirstForm === 3 && (studentInfo_PersonalInfo?.Student_Identity?.citizenship.length === 0 || studentInfo_PersonalInfo?.Student_Identity?.citizenship === undefined)) {
			if (firstFormButton.button4 === true) {
				document.getElementById('citizenship').getElementsByClassName('MuiFilledInput-root')[0].style.border = '1px solid red';
	        	document.getElementById('citizenship').getElementsByClassName('errorValue')[0].style.display = 'block';
			}
		}
	...
	useEffect(() => {
		studentResolvers.exist_student_by_username(studentInfo_PersonalInfo?.Personal_Information?.username)
			.then(result=> { 
				result?.data?.existStudentByUsername === true ? setExistStudentByUsername(true) : setExistStudentByUsername(false); 
			})
			.catch(error=> {
				throw error;
			})
	}, [studentInfo_PersonalInfo?.Personal_Information?.username])
	...
	useEffect(() => {
		studentResolvers.exist_student_by_AEM(studentInfo_StudentshipInfo?.General_Information?.academic_record_number)
			.then(result=> { 
				result?.data?.existStudentByAEM === true ? setExistStudentByAEM(true) : setExistStudentByAEM(false); 
			})
			.catch(error=> {
				throw error;
			})
	}, [studentInfo_StudentshipInfo?.General_Information?.academic_record_number])
	...
	useEffect(() => {
		studentResolvers.exist_student_by_uth_email(studentInfo_PersonalInfo?.Student_Address?.uth_email)
			.then(result=> { 
				result?.data?.existStudentByUthEmail === true ? setExistStudentByUthEmail(true) : setExistStudentByUthEmail(false); 
			})
			.catch(error=> {
				throw error;
			})
	...
	useEffect(() => {
		studentResolvers.exist_student_by_academic_identity(studentInfo_PersonalInfo?.Personal_Information?.student_identity)
			.then(result=> { 
				result?.data?.existStudentBystudentIdentity === true ? setExistStudentByStudentIdentity(true) : setExistStudentByStudentIdentity(false); 
			})
			.catch(error=> {
				throw error;
			})
	...
	useEffect(() => {
		studentResolvers.exist_student_by_AMKA(studentInfo_PersonalInfo?.Student_Insurance?.AMKA_number)
			.then(result=> { 
				result?.data?.existStudentByAMKA === true ? setExistStudentByAMKA(true) : setExistStudentByAMKA(false); 
			})
			.catch(error=> {
				throw error;
			})
	}, [studentInfo_PersonalInfo?.Student_Insurance?.AMKA_number])
	...
	useEffect(() => {
		studentResolvers.exist_student_by_AFM(studentInfo_PersonalInfo?.Student_Insurance?.AFM_number)
			.then(result=> { 
				result?.data?.existStudentByAFM === true ? setExistStudentByAFM(true) : setExistStudentByAFM(false); 
			})
			.catch(error=> {
				throw error;
			})
    ...
    useEffect(() => {
		if ((activeStepFirstForm === 6) && (activeStepSecondForm === 4)) { 
			setModalShow(true);		 
		}
	}, [activeStepFirstForm, activeStepSecondForm]) 

	let [modalResultInside, setModalResultInside] = useState('');

	// Handling Modal Results
    useEffect(() => {		
    console.log(modalResultInside, 'Modal State')
		if (modalResultInside === 'close') {
			setStudentInfo_PersonalInfo(studentInfo_PersonalInfo_default); 
			setStudentInfo_StudentshipInfo(studentInfo_StudentshipInfo_default);
			setActiveStepFirstForm(0); 
			setActiveStepSecondForm(0);
			setReadyToComplete(false); 
			setModalResultInside('');
		}
		if (modalResultInside === 'check') { 
			setReadyToComplete(true); 
			setModalResultInside('');
		}
		if (modalResultInside === 'add') {
			let studentInput = {Personal_Info : studentInfo_PersonalInfo, Studentship_Info: studentInfo_StudentshipInfo}
			studentResolvers.add_student(studentInput)
				.then(result=> {
					console.log(result?.data?.addStudent?.code)
					if (result?.data?.addStudent?.code === "S-0K") {
						setReadyToComplete(false);
						setIsAdding(true);
						setStudentInfo_PersonalInfo(studentInfo_PersonalInfo_default); 
						setStudentInfo_StudentshipInfo(studentInfo_StudentshipInfo_default);   
					...
					else if (result?.data?.addStudent?.code === "S-N0K") {
						setIsAdding(false);
						setIsNotAdding(true);
						setReadyToComplete(false);
						setStudentInfo_PersonalInfo(studentInfo_PersonalInfo_default); 
	...
	}, [modalResultInside, studentInfo_PersonalInfo_default, studentInfo_StudentshipInfo_default, studentInfo_PersonalInfo, studentInfo_StudentshipInfo])
						...
						<Form.Group as={Col} id='grade_average'>
							...
							><Form.Label>Μέσος Όρος Μαθημάτων<div style={{marginLeft:'3px', display:'inline-flex', color:'red'}}>*</div></Form.Label></OverlayTrigger>															
								<Form.Control required isInvalid ={((secondFormButton.button4 === true && (studentInfo_StudentshipInfo?.Grade_State?.grade_average === undefined || studentInfo_StudentshipInfo?.Grade_State?.grade_average === '' || studentInfo_StudentshipInfo?.Grade_State?.grade_average < 0 || studentInfo_StudentshipInfo?.Grade_State?.grade_average > 10)) || (studentInfo_StudentshipInfo?.Grade_State?.grade_average !== undefined && studentInfo_StudentshipInfo?.Grade_State?.grade_average !== '' && (studentInfo_StudentshipInfo?.Grade_State?.grade_average < 0  || studentInfo_StudentshipInfo?.Grade_State?.grade_average)))}
									style={{backgroundImage:'none'}} min={0} max={10} type="number" placeholder="Μέσος Όρος Μαθημάτων" className="control" value={studentInfo_StudentshipInfo.Grade_State?.grade_average}								
        ...
        <div className="submit_main">
            <div className="scroll">
                ...
                <div className="forms_container">
                    <div className="text">Ο αριθμός των φοιτητών που εισάγονται κάθε χρόνο στο Πολυτεχνικό Τμήμα Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Πανεπιστημίου Θεσσαλίας καθορίζεται τόσο από το Υπουργείο Παιδείας όσο και από το ίδιο το Τμήμα που έχει λόγο για τον αριθμό των φοιτητών που θα δεχτεί κάθε νέο ακαδημαϊκό έτος. Στην πραγματικότητα, το ΤΗΜΜΥ ελκύει πολλούς/ές φοιτητές/τριες, με αποτέλεσμα τα τελευταία χρόνια να έχει αυξηθεί σημαντικά ο αριθμός των φοιτητών/τριών που φοιτούν στο Τμήμα. Ορισμένοι/ες εγγράφονται ως φοιτητές/τριες πλήρους φοίτησης σε προπτυχιακά ή μεταπτυχιακά προγράμματα, ενώ άλλοι συμμετέχουν στα προγράμματα ανταλλαγής φοιτητών/τριών και παρακολουθούν μαθήματα στο ΤΗΜΜΥ για ένα ή δύο εξάμηνα, έχοντας παράλληλα ενεργή συμμετοχή τόσο στην ακαδημαϊκή ζωή του τμήματος όσο και στην πλούσια πολιτιστική ζωή μέσα και έξω από το τμήμα. Για την εισαγωγή ενός νέου φοιτητή στο Τμήμα μας, παρακαλώ συμπληρώστε κατάλληλα τα στοιχεία στη φόρμα που ακολουθεί. Με την υποβολή των στοιχείων, η Ηλεκτρονική Γραμματεία θα προσθέσει ένα νέο μέλος στην πανεπιστημιακή κοινότητα του τμήματός μας.</div>           
                </div> 
                <div className='root'>
				    <h1 className="main_title">Εισαγωγή Νέου Φοιτητή</h1>
                </div>
				...
				<Box
					...
					>
						<TabPanel value={value} index={0} dir={theme.direction}>
							...
							{activeStepFirstForm === steps.length && isAdding === false && readyToComplete === true &&(
								<Button	
							...
							{isNotAdding === true && isAdding === false && (												 
							<>				 
								<Paper style={{backgroundColor:'transparent'}} square elevation={0} className={classes.resetContainer}>							
									<div className="submitted" style={{display:'flex', gap:'2rem', alignItems:'center', justifyContent:'center', flexWrap:'wrap'}}> 
									<FcHighPriority style={{fontSize:'75px', verticalAlign:'middle', position:'inline'}}/>
									<div className="registration_text" style={{fontSize: '1.5rem', fontWeight:'700', letterSpacing:'2px', color : 'hsl(197, 96%, 18%)', textAlign:'center',
													fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}}>Αποτυχής Καταχώρηση Φοιτητή !</div>
									</div>
								</Paper>
							<button 
									onClick={() => {handleReset()}}
						...
						<TabPanel value={value} index={1} dir={theme.direction}>
						   ...
						   {activeStepSecondForm === steps_second.length && isAdding === false && readyToComplete === true && (
								<Button	
								style={{backgroundColor:'#17a2b8', color:'white', marginTop:'-3.25rem', marginLeft:'-2.5rem'}}
								variant="contained"								 
								onClick={() => setModalShow(true)}
			...
			<MyVerticallyCenteredModal	 
			    new_student = {{personal_info : studentInfo_PersonalInfo, studenship_info : studentInfo_StudentshipInfo}} 
				show={modalShow}
				onChange={(tag) => tag === 'close' ? setModalResultInside('close') : tag === 'check' ? setModalResultInside('check') : setModalResultInside('add')}
